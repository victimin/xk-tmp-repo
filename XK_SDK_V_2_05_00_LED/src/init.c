...
void InitInfo(XK_HTTPHandle_t * XK_HTTPHandle, XK_InitInfo_t *initInfo){
    ...
    confLv3Obj_mqtt = XK_GetLowObjFromHighObj_Sel(confLv2Obj[XK_LV1_OBJ_CONFIG], "mqtt");
    ...
    XK_GetStringFromObject(XK_HTTPHandle->MqttInfo.address, confLv3Obj_mqtt, "address");
    XK_GetStringFromObject(XK_HTTPHandle->MqttInfo.topic, confLv3Obj_mqtt, "topic");
    XK_GetStringFromObject(XK_HTTPHandle->MqttInfo.username, confLv3Obj_mqtt, "username");
    XK_GetStringFromObject(XK_HTTPHandle->MqttInfo.password, confLv3Obj_mqtt, "password");
    XK_GetStringFromObject(XK_HTTPHandle->MqttInfo.cert, confLv3Obj_mqtt, "cert-key");
    XK_HTTPHandle->MqttInfo.mqttPort = XK_GetNumFromObject(confLv3Obj_mqtt, "port");
    XK_HTTPHandle->MqttInfo.frequency = XK_GetNumFromObject(confLv3Obj_mqtt, "frequency");
