...
#define IBCON_TIMEOUT_SEC               (120)    //second
...
#define IMAGE_VERSION_FILE              "/boot/XandarKardian/image/version"
#define MYPID_PATH                      "/etc/xkble/pre-pid"
#define HOSTAPD_CONF_FILE               "hostapd.conf"
#define HOSTAPD_CONF_PATH_FILE          "/etc/hostapd/hostapd.conf"
//Production
#define DEVIENAME                       "GW %s"
#define AP_SSID                         "xkbgw-"
...
#define STATIC_WIFI_CHANNEL_PREIOD      10      //min


/*********************************************** 
 *  GPIO
************************************************/
#define GPIO_UART_RST                   18 // Active-low button - Broadcom pin 17, P1 pin 11
...
typedef enum
{
        XK_COMM_STATUS_NO_MQTT_CERT  = -5,
        XK_COMM_STATUS_NO_RESP  = -1,
        XK_COMM_STATUS_OFF      = 0,
        XK_COMM_STATUS_GOOD     = 1,
} XK_COMM_STATUS;
