...
void XK_LED_LIGHT_RED(char onOff){
    digitalWrite(LEDLIGHT_RED_PIN, onOff); 
}

void XK_LED_LIGHT_YELLOW(char onOff){
    digitalWrite(LEDLIGHT_YELLOW_PIN, onOff); 
}

void XK_LED_LIGHT_GREEN(char onOff){
    digitalWrite(LEDLIGHT_GREEN_PIN, onOff);
}
...
int AlgorithmThreadInit(void)
{
    ...
    int USBthreadCreate[MAX_NUM_USB_DEVICE], thread0Create, thread1Create, thread2Create, thread3Create, threadMythingsCreate, threadComboCreate, i, temp;
...
# if 1
        ...
        threadComboCreate = pthread_create(&XK_Combination_Thread_t, NULL, (void *)XK_CombinationThread, (void *)'a');
